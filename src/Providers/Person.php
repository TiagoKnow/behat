...
use \Faker\Provider\Person as SourcePerson;

require_once "check_digit.php";

class Person extends SourcePerson
{
    ...
    protected static $firstNameMale = array(
        ...
        'João', 'Jurandir', 'Kevin', 'Leandro', 'Leonardo', 'Lucas', 'Luciano', 'Luis', 'Manuel', 'Mateus', 'Matias', 'Miguel', 'Mário',
    ...
    protected static $lastName = array(
        ...
        'Dias', 'Domingues', 'Dominato', 'Duarte', 'Dacol', 'Escobar', 'Espinoza',
